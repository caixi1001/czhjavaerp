...
@ApiModel(value="Sellcancel对象", description="")
public class Sellcancel extends Model<Sellcancel> {
    ...
    public static final String WHETHERANEWENTERSTORAGE = "whetheranewenterstorage";
